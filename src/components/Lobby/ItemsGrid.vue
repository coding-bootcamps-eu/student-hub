    ...
    <template v-if="isStudent || isStudentView">
      <nav class="lobby-grid__nav">
        ...
        >
          ...
          <span class="lobby-grid__link-text">Report absence</span>
        </a>
        ...
        <router-link class="lobby-grid__link card card-accent" to="/slides">
          <svg
            xmlns="http://www.w3.org/2000/svg"
            fill="currentColor"
          ...
          <span class="lobby-grid__link-text">Slides</span>
        </router-link>
        <router-link
          class="lobby-grid__link card card-accent"
          to="/zoom"
