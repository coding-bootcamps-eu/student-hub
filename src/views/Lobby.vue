  ...
  <section>
    ...
    <div class="home">
      ...
      <nav class="home__nav">
        ...
        <router-link class="home__link" to="/timer">
          <svg
            xmlns="http://www.w3.org/2000/svg"
            fill="currentColor"
            class="bi bi-stopwatch home__link-icon"
            viewBox="0 0 16 16"
          >
            <path
          ...
          <span class="home__link-text">Timer</span>
        </router-link>
        ...
        <router-link
          class="home__link"
          to="/1on1"
          v-if="this.$store.getters.isPartTimeStudent"
        >
          <svg
            xmlns="http://www.w3.org/2000/svg"
            fill="currentColor"
